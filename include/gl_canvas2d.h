...
public:
    ...
    static void point(Vector2d pos);     // coordeandas do ponto
    static void point(Vector2f pos);     // coordeandas do ponto

    static void line(float x1, float y1, float x2, float y2); // coordenadas da linha x1, y1, x2, y2
    static void line(Vector2d p1, Vector2d p2);               // coordenadas da linha (p1, p2)
    ...
    static void rect(Vector2d p1, Vector2d p2);               // coordenadas do retangulo (p1, p2) - TO DO

    static void rectFill(float x1, float y1, float x2, float y2); // coordenadas do retangulo x1, y1, x2, y2
    static void rectFill(Vector2d p1, Vector2d p2);               // coordenadas do retangulo (p1, p2)
    ...
    static void circle(Vector2d pos, float radius, int div);

    static void circleFill(float x, float y, float radius, int div);
    static void circleFill(Vector2d pos, float radius, int div);
    ...
    static void text(Vector2d pos, const char *t); // varias funcoes ainda nao tem implementacao. Faca como exercicio ok
    static void text(Vector2d pos, int valor);     // varias funcoes ainda nao tem implementacao. Faca como exercicio
    static void text(Vector2d pos, float valor);   // varias funcoes ainda nao tem implementacao. Faca como exercicio

    static void textf(float x, float y, const char *t, ...);
    static void textf(Vector2d pos, const char *t, ...);
